...
package TG68K_MMU_Pack is
	...
	type mmu_instruction_operation_t is (MMU_OP_NONE, MMU_OP_PMOVE_TO_MMU,
		MMU_OP_PMOVE_FROM_MMU, MMU_OP_PLOAD, MMU_OP_PTEST,
		MMU_OP_PFLUSH_ALL, MMU_OP_PFLUSH_FC, MMU_OP_PFLUSH_PAGE);
	type mmu_fc_source_t is (MMU_FC_SOURCE_SFC, MMU_FC_SOURCE_DFC,
		MMU_FC_SOURCE_DATA_REGISTER, MMU_FC_SOURCE_IMMEDIATE);
	type mmu_operand_size_t is (MMU_SIZE_NONE, MMU_SIZE_WORD,
		MMU_SIZE_LONG, MMU_SIZE_QUAD);
