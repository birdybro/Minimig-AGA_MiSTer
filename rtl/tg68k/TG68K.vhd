...
cpu1: entity work.TG68KdotC_Kernel
   ...
   PORT MAP(
      ...
      FPU_instruction_operand_format => FPU_FORMAT_EXTENDED,
      FPU_instruction_family => FPU_FAMILY_NONE,
      ...
      FPU_conditional_branch_taken => '0',
      FPU_conditional_trap_taken => '0',
      ...
      FPU_address_register_select => "000",
      FPU_address_register_write => '0',
      FPU_address_register_write_data => (others => '0'),
