...
begin
	...
	begin
		...
		assert trace_count = 0 and
			fp_registers(4) = x"3FFEB17217F7D1CF79AC" and
			fpsr(31 downto 28) = "0000" and fpsr(15 downto 8) = x"02"
			report "register FLOGN system result mismatch" severity failure;

		clear_observations;
		effective_address <= x"00009004";
		function_code <= "101";
		start_instruction(x"F210", x"4614", '1');
		command_word <= x"0000";
		wait_done;
		assert trace_count = 2 and trace_write(0) = '0' and
			trace_address(0) = x"00009004" and
			trace_address(1) = x"00009006" and trace_fc(1) = "101" and
			fp_registers(4) = x"BFFEB17217F7D1CF79AC" and
			fpsr(31 downto 28) = "1000" and fpsr(15 downto 8) = x"02"
			report "memory single FLOGN system result mismatch" severity failure;
		...
		assert trace_count = 0 and
			fp_registers(4) = x"40008000000000000000" and
			fpsr(31 downto 28) = "0000" and fpsr(15 downto 8) = x"00"
			report "register FLOG2 system result mismatch" severity failure;

		clear_observations;
		effective_address <= x"00009008";
		function_code <= "101";
		start_instruction(x"F210", x"4616", '1');
		command_word <= x"0000";
		wait_done;
		assert trace_count = 2 and trace_write(0) = '0' and
			trace_address(0) = x"00009008" and
			trace_address(1) = x"0000900A" and trace_fc(1) = "101" and
		...
		assert trace_count = 0 and
			...
			fpsr(31 downto 28) = "0000" and fpsr(15 downto 8) = x"02"
			report "register FATAN system result mismatch" severity failure;

		clear_observations;
		effective_address <= x"00009004";
		function_code <= "101";
		start_instruction(x"F210", x"460A", '1');
		command_word <= x"0000";
		wait_done;
		assert trace_count = 2 and trace_write(0) = '0' and
			trace_address(0) = x"00009004" and
		...
		effective_address <= x"00009004";
		function_code <= "101";
		start_instruction(x"F210", x"469C", '1');
		command_word <= x"0000";
		wait_done;
		assert trace_count = 2 and trace_write(0) = '0' and
			trace_address(0) = x"00009004" and
		...
		effective_address <= x"00009004";
		function_code <= "101";
		start_instruction(x"F210", x"468E", '1');
		command_word <= x"0000";
		wait_done;
		assert trace_count = 2 and trace_write(0) = '0' and
			trace_address(0) = x"00009004" and
			trace_address(1) = x"00009006" and trace_fc(1) = "101" and
			fp_registers(5) = x"3FFDF57743A2582F7F44" and
			fpsr(31 downto 28) = "0000" and fpsr(15 downto 8) = x"02"
			report "memory single FSIN system result mismatch: fp5=" &
		...
		wait_done;
		clear_observations;
		start_instruction(x"F200", x"0E0D", '1');
		command_word <= x"0000";
		wait_done;
		assert trace_count = 0 and
			fp_registers(4) = x"3FFDED63382B0DDA7B45" and
			fpsr(31 downto 28) = "0010" and fpsr(15 downto 8) = x"04"
		...
		effective_address <= x"00009004";
		function_code <= "101";
		start_instruction(x"F210", x"460D", '1');
		command_word <= x"0000";
		wait_done;
		assert trace_count = 2 and trace_write(0) = '0' and
			trace_address(0) = x"00009004" and
			trace_address(1) = x"00009006" and trace_fc(1) = "101" and
			fp_registers(4) = x"3FFE8C9F53D5681854BB" and
			fpsr(31 downto 28) = "0000" and fpsr(15 downto 8) = x"02"
			report "memory single FATANH system result mismatch" severity failure;
		...
		assert trace_count = 0 and
			...
			fpsr(31 downto 28) = "0000" and fpsr(15 downto 8) = x"02"
			report "register FCOSH system result mismatch" severity failure;

		clear_observations;
		effective_address <= x"00009004";
		function_code <= "101";
		start_instruction(x"F210", x"4619", '1');
		command_word <= x"0000";
		wait_done;
		assert trace_count = 2 and trace_write(0) = '0' and
			trace_address(0) = x"00009004" and
			trace_address(1) = x"00009006" and trace_fc(1) = "101" and
			fp_registers(4) = x"3FFF90560C3157468323" and
			fpsr(31 downto 28) = "0000" and fpsr(15 downto 8) = x"02"
			report "memory single FCOSH system result mismatch" severity failure;
		...
		assert trace_count = 0 and
			...
			fpsr(31 downto 28) = "0000" and fpsr(15 downto 8) = x"02"
			report "register FTANH system result mismatch" severity failure;

		clear_observations;
		effective_address <= x"00009004";
		function_code <= "101";
		start_instruction(x"F210", x"4609", '1');
		command_word <= x"0000";
		wait_done;
		assert trace_count = 2 and trace_write(0) = '0' and
			trace_address(0) = x"00009004" and
			trace_address(1) = x"00009006" and trace_fc(1) = "101" and
			fp_registers(4) = x"3FFDEC9A9EBAB4579B29" and
			fpsr(31 downto 28) = "0000" and fpsr(15 downto 8) = x"02"
		...
		assert trace_count = 0 and
			...
			fpsr(31 downto 28) = "0000" and fpsr(15 downto 8) = x"02"
			report "register FTAN system result mismatch" severity failure;

		clear_observations;
		effective_address <= x"00009004";
		function_code <= "101";
		start_instruction(x"F210", x"478F", '1');
		command_word <= x"0000";
		wait_done;
		assert trace_count = 2 and trace_write(0) = '0' and
			trace_address(0) = x"00009004" and
			trace_address(1) = x"00009006" and trace_fc(1) = "101" and
			fp_registers(7) = x"3FFE8BDA7ADF9A3A5219" and
			fpsr(31 downto 28) = "0000" and fpsr(15 downto 8) = x"02"
