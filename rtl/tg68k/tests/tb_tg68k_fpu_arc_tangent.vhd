...
begin
	...
	stimulus : process
		...
		begin
			...
			while done = '0' loop
				...
				wait for 1 ns;
				cycles := cycles + 1;
				assert cycles < 550 report "inverse circular timeout" severity failure;
			end loop;
	...
	begin
		...
		execute(x"3FFE8000000000000000", x"3FFE860A91C16B9B2C23", x"0", x"02", '1', 456);
		...
		execute(x"3FFEFFFFFFFFFFFFFFFF", x"3FFFC90FDAA16C63CF01", x"0", x"02", '1', 455);
		...
		execute(x"3FFE8000000000000000", x"3FFF860A91C16B9B2C23", x"0", x"02", '0', 455, '1');
		execute(x"BFFE8000000000000000", x"4000860A91C16B9B2C23", x"0", x"02", '0', 455, '1');
		execute(x"3FFEFFFFFFFFFFFFFFFF", x"3FDFB504F333F9DE6484", x"0", x"02", '0', 487, '1');
