...
| FADD, FSUB, and FCMP | MC68881UM 2.2.2, 2.3.1, 4.5.3-4.5.5, 4.6 FADD/FCMP/FSUB, 6.1.2-6.1.7 | `TG68K_FPU_Add_Subtract.vhd`, `TG68K_FPU_Binary_Controller.vhd`, `TG68K_FPU_System.vhd` | 67-bit GRS alignment, cancellation normalization, all rounding modes/precisions, signed zero, infinity, NaN propagation, SNAN/OPERR destination suppression, overflow/underflow/inexact, FCMP infinity rules, register/Dn/memory transfers, retry, 512 deterministic exact-rational differential vectors, and real instruction streams |
