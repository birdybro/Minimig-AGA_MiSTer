...
begin
	...
	begin
		...
		execute(x"400D8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"7FFF8000000000000000", x"12", 47);
		execute(x"400D8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_ZERO, x"7FFEFFFFFFFFFFFFFFFF", x"12", 47);
		execute(x"C00D807E000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"00000000000000000000", x"0A", 47);
		execute(x"C00D807E000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_PLUS_INFINITY, x"00000000000000000001", x"0A", 47);

		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"4000ADF85458A2BB4A9B", x"02", 441,
			FPU_EXP_BASE_E);
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFDBC5AB1B16779BE35", x"02", 441,
			FPU_EXP_BASE_E);
		execute(x"3FFE8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFFD3094C70F034DE4C", x"02", 440,
			FPU_EXP_BASE_E);
		execute(x"4000D000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"4003CE529DBC088A578B", x"02", 442,
			FPU_EXP_BASE_E);
		execute(x"400D8000000000000000", FPU_PRECISION_EXTENDED,
		...
		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"4002A000000000000000", x"02", 441,
			FPU_EXP_BASE_TEN);
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFBCCCCCCCCCCCCCCCD", x"02", 441,
			FPU_EXP_BASE_TEN);
		execute(x"3FFE8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"4000CA62C1D6D2DA9490", x"02", 440,
			FPU_EXP_BASE_TEN);
		execute(x"4000D000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"4009DE48F0ED526B1EDF", x"02", 442,
			FPU_EXP_BASE_TEN);
		...
		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFFDBF0A8B145769535", x"02", 444,
			FPU_EXP_BASE_E, '1');
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"BFFEA1D2A7274C4320E5", x"02", 445,
			FPU_EXP_BASE_E, '1');
		execute(x"00000000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"00000000000000000000", x"00", 0,
			FPU_EXP_BASE_E, '1');
		...
		execute(x"7FFFA123456789ABCDEF", FPU_PRECISION_EXTENDED,
			...
			FPU_EXP_BASE_E, '0', '1');
		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFF966CFE2275CC12D4", x"02", 445,
			FPU_EXP_BASE_E, '0', '1');
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"BFFF966CFE2275CC12D4", x"02", 445,
			FPU_EXP_BASE_E, '0', '1');
		execute(x"3FFE8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFE8566807F31DCB652", x"02", 442,
			FPU_EXP_BASE_E, '0', '1');
		execute(x"3FFFC000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"400088461D55EB530366", x"02", 447,
			FPU_EXP_BASE_E, '0', '1');
		...
		execute(x"7FFFA123456789ABCDEF", FPU_PRECISION_EXTENDED,
			...
			FPU_EXP_BASE_E, '0', '0', '1');
		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFFC583AA8ECFAA8261", x"02", 445,
			FPU_EXP_BASE_E, '0', '0', '1');
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFFC583AA8ECFAA8261", x"02", 445,
			FPU_EXP_BASE_E, '0', '0', '1');
		execute(x"3FFE8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFF90560C3157468323", x"02", 442,
			FPU_EXP_BASE_E, '0', '0', '1');
		execute(x"3FFFC000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"4000968DE10F11011218", x"02", 447,
			FPU_EXP_BASE_E, '0', '0', '1');
		execute(x"3FE58000000000000000", FPU_PRECISION_EXTENDED,
		...
		execute(x"7FFFA123456789ABCDEF", FPU_PRECISION_EXTENDED,
			...
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFEC2F7D5A8A79CA2AC", x"02", 511,
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"BFFEC2F7D5A8A79CA2AC", x"02", 511,
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"3FFE8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFDEC9A9EBAB4579B29", x"02", 509,
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"3FFFC000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFEE7B7CBC36FABBB07", x"02", 513,
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"3FE58000000000000000", FPU_PRECISION_EXTENDED,
