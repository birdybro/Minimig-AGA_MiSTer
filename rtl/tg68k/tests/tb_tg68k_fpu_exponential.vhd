...
begin
	...
	begin
		...
		execute(x"7FFFA123456789ABCDEF", FPU_PRECISION_EXTENDED,
			...
			FPU_EXP_BASE_E, '0', '1');
		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFF966CFE2275CC12D4", x"02", 447,
			FPU_EXP_BASE_E, '0', '1');
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"BFFF966CFE2275CC12D4", x"02", 447,
			FPU_EXP_BASE_E, '0', '1');
		execute(x"3FFE8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFE8566807F31DCB652", x"02", 444,
			FPU_EXP_BASE_E, '0', '1');
		execute(x"3FFFC000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"400088461D55EB530366", x"02", 449,
			FPU_EXP_BASE_E, '0', '1');
		...
		execute(x"7FFFA123456789ABCDEF", FPU_PRECISION_EXTENDED,
			...
			FPU_EXP_BASE_E, '0', '0', '1');
		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFFC583AA8ECFAA8261", x"02", 447,
			FPU_EXP_BASE_E, '0', '0', '1');
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFFC583AA8ECFAA8261", x"02", 447,
			FPU_EXP_BASE_E, '0', '0', '1');
		execute(x"3FFE8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFF90560C3157468323", x"02", 444,
			FPU_EXP_BASE_E, '0', '0', '1');
		execute(x"3FFFC000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"4000968DE10F11011218", x"02", 449,
			FPU_EXP_BASE_E, '0', '0', '1');
		execute(x"3FE58000000000000000", FPU_PRECISION_EXTENDED,
		...
		execute(x"7FFFA123456789ABCDEF", FPU_PRECISION_EXTENDED,
			...
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFEC2F7D5A8A79CA2AC", x"02", 514,
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"BFFEC2F7D5A8A79CA2AC", x"02", 514,
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"3FFE8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFDEC9A9EBAB4579B29", x"02", 512,
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"3FFFC000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFEE7B7CBC36FABBB07", x"02", 516,
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"3FE58000000000000000", FPU_PRECISION_EXTENDED,
