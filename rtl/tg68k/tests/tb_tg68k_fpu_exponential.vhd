...
begin
	...
	begin
		...
		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"40008000000000000000", x"02", 34);
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFE8000000000000000", x"02", 34);
		execute(x"3FFE8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFFB504F333F9DE6484", x"02", 329);
		execute(x"BFFE8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_PLUS_INFINITY, x"3FFEB504F333F9DE6485", x"02", 329);
		execute(x"4000D000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"40029837F0518DB8A96F", x"02", 331);
		execute(x"3FFF4000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFFB504F333F9DE6484", x"02", 329);

		execute(x"3FFE8000000000000000", FPU_PRECISION_DOUBLE,
			FPU_ROUND_ZERO, x"3FFFB504F333F9DE6000", x"02", 329);
		execute(x"3FFE8000000000000000", FPU_PRECISION_SINGLE,
			FPU_ROUND_PLUS_INFINITY, x"3FFFB504F40000000000", x"02", 329);

		execute(x"3F9B8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_PLUS_INFINITY, x"3FFF8000000000000001", x"02", 1);
		execute(x"BF9B8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_ZERO, x"3FFEFFFFFFFFFFFFFFFF", x"02", 1);

		execute(x"400D8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"7FFF8000000000000000", x"12", 48);
		execute(x"400D8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_ZERO, x"7FFEFFFFFFFFFFFFFFFF", x"12", 48);
		execute(x"C00D807E000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"00000000000000000000", x"0A", 48);
		execute(x"C00D807E000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_PLUS_INFINITY, x"00000000000000000001", x"0A", 48);

		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"4000ADF85458A2BB4A9B", x"02", 442,
			FPU_EXP_BASE_E);
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFDBC5AB1B16779BE35", x"02", 442,
			FPU_EXP_BASE_E);
		execute(x"3FFE8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFFD3094C70F034DE4C", x"02", 441,
			FPU_EXP_BASE_E);
		execute(x"4000D000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"4003CE529DBC088A578B", x"02", 443,
			FPU_EXP_BASE_E);
		execute(x"400D8000000000000000", FPU_PRECISION_EXTENDED,
		...
		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"4002A000000000000000", x"02", 442,
			FPU_EXP_BASE_TEN);
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFBCCCCCCCCCCCCCCCD", x"02", 442,
			FPU_EXP_BASE_TEN);
		execute(x"3FFE8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"4000CA62C1D6D2DA9490", x"02", 441,
			FPU_EXP_BASE_TEN);
		execute(x"4000D000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"4009DE48F0ED526B1EDF", x"02", 443,
			FPU_EXP_BASE_TEN);
		...
		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFFDBF0A8B145769535", x"02", 445,
			FPU_EXP_BASE_E, '1');
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"BFFEA1D2A7274C4320E5", x"02", 446,
			FPU_EXP_BASE_E, '1');
		execute(x"00000000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"00000000000000000000", x"00", 0,
			FPU_EXP_BASE_E, '1');
		...
		execute(x"3FE38000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FE38000000400000015", x"02", 407,
			FPU_EXP_BASE_E, '1');
		execute(x"BFE38000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"BFE2FFFFFFF80000002B", x"02", 407,
			FPU_EXP_BASE_E, '1');
		execute(x"3FD78000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FD78000000000400000", x"02", 164,
			FPU_EXP_BASE_E, '1');
		execute(x"BFD78000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"BFD6FFFFFFFFFF800000", x"02", 164,
			FPU_EXP_BASE_E, '1');
		execute(x"3F9B8000000000000000", FPU_PRECISION_EXTENDED,
		...
		execute(x"7FFFA123456789ABCDEF", FPU_PRECISION_EXTENDED,
			...
			FPU_EXP_BASE_E, '0', '1');
		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFF966CFE2275CC12D4", x"02", 446,
			FPU_EXP_BASE_E, '0', '1');
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"BFFF966CFE2275CC12D4", x"02", 446,
			FPU_EXP_BASE_E, '0', '1');
		execute(x"3FFE8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFE8566807F31DCB652", x"02", 443,
			FPU_EXP_BASE_E, '0', '1');
		execute(x"3FFFC000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"400088461D55EB530366", x"02", 448,
			FPU_EXP_BASE_E, '0', '1');
		execute(x"3FE58000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FE58000000000000155", x"02", 308,
			FPU_EXP_BASE_E, '0', '1');
		...
		execute(x"7FFFA123456789ABCDEF", FPU_PRECISION_EXTENDED,
			...
			FPU_EXP_BASE_E, '0', '0', '1');
		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFFC583AA8ECFAA8261", x"02", 446,
			FPU_EXP_BASE_E, '0', '0', '1');
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFFC583AA8ECFAA8261", x"02", 446,
			FPU_EXP_BASE_E, '0', '0', '1');
		execute(x"3FFE8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFF90560C3157468323", x"02", 443,
			FPU_EXP_BASE_E, '0', '0', '1');
		execute(x"3FFFC000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"4000968DE10F11011218", x"02", 448,
			FPU_EXP_BASE_E, '0', '0', '1');
		execute(x"3FE58000000000000000", FPU_PRECISION_EXTENDED,
		...
		execute(x"7FFFA123456789ABCDEF", FPU_PRECISION_EXTENDED,
			...
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"3FFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFEC2F7D5A8A79CA2AC", x"02", 512,
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"BFFF8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"BFFEC2F7D5A8A79CA2AC", x"02", 512,
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"3FFE8000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFDEC9A9EBAB4579B29", x"02", 510,
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"3FFFC000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FFEE7B7CBC36FABBB07", x"02", 514,
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"3FE58000000000000000", FPU_PRECISION_EXTENDED,
			FPU_ROUND_NEAREST, x"3FE4FFFFFFFFFFFFFAAB", x"02", 308,
			FPU_EXP_BASE_E, '0', '0', '0', '1');
		execute(x"3FDE8000000000000000", FPU_PRECISION_EXTENDED,
