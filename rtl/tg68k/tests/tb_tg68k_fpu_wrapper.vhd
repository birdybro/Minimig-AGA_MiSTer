...
architecture test of tb_tg68k_fpu_wrapper is
	...
	begin
		...
		result(16#0C02#) := x"4001";
		result(16#0C03#) := x"0001";
		result(16#0C04#) := x"0000";
		result(16#0C05#) := x"0000";
		result(16#0C06#) := x"0000";
		result(16#0C07#) := x"0000";
		...
		result(16#0879#) := x"7402";
		result(16#087A#) := x"F202";
		result(16#087B#) := x"4194";
		result(16#087C#) := x"F239";
		...
		result(16#0887#) := x"740A";
		result(16#0888#) := x"F202";
		result(16#0889#) := x"4195";
		result(16#088A#) := x"F239";
		...
		result(16#089C#) := x"F202";
		result(16#089D#) := x"4199";
		result(16#089E#) := x"F239";
		...
		result(16#08B8#) := x"F239";
		result(16#08B9#) := x"459C";
		result(16#08BA#) := x"0000";
		result(16#08BB#) := x"1800";
		result(16#08BC#) := x"F239";
		...
		result(16#08C8#) := x"F239";
		result(16#08C9#) := x"461D";
		result(16#08CA#) := x"0000";
		result(16#08CB#) := x"1800";
		result(16#08CC#) := x"F239";
		...
		result(16#08E4#) := x"F239";
		result(16#08E5#) := x"4C00";
		result(16#08E6#) := x"0000";
		result(16#08E7#) := x"1804";
		result(16#08E8#) := x"F239";
...
begin
		...
		if rising_edge(clk) then
			...
			if busstate = "11" and not is_x(addr_out) then
				...
				if addr_out = x"00000B64" or addr_out = x"00000B66" or
						...
						addr_out = x"00000B6C" or addr_out = x"00000B6E" or
						addr_out = x"00000B70" or addr_out = x"00000B72" then
				...
				if addr_out = x"00000B7C" or addr_out = x"00000B7E" then
				...
				if addr_out = x"00000BA4" or addr_out = x"00000BA6" then
	...
	begin
		...
		assert exponential_result_write_count = 8 and
			...
			severity failure;
		assert logarithm_result_write_count = 8 and
			...
			severity failure;
		assert memory(16#05B4#) = x"3F31" and memory(16#05B5#) = x"7218"
		...
		assert memory(16#05B6#) = x"4000" and memory(16#05B7#) = x"0000"
			...
			severity failure;
		assert memory(16#05B8#) = x"3F80" and memory(16#05B9#) = x"0000"
			report "TG68K FLOG10 instruction stream mismatch: " &
		...
		assert hyperbolic_result_write_count = 2 and
			...
			severity failure;
		assert hyperbolic_cosine_result_write_count = 2 and
			memory(16#05BE#) = x"3FC5" and memory(16#05BF#) = x"83AB"
		...
		assert arc_sine_result_write_count = 2 and
			...
			severity failure;
		assert arc_cosine_result_write_count = 2 and
			memory(16#05C6#) = x"3F86" and memory(16#05C7#) = x"0A92"
			report "TG68K FACOS instruction stream mismatch: " &
		...
		assert sine_result_write_count = 2 and
			...
			severity failure;
		assert cosine_result_write_count = 2 and
			memory(16#05CA#) = x"3F60" and memory(16#05CB#) = x"A940"
		...
		assert sincos_cosine_result_write_count = 2 and
			...
			severity failure;
		assert packed_input_transfer_count = 6 and
			packed_result_write_count = 2 and
			memory(16#05D2#) = x"3DCC" and memory(16#05D3#) = x"CCCD"
