...
begin
	...
	begin
		...
		execute('1', x"3FBB8000000000000000", x"3FBB8000000000000000",
			x"0", x"02", '0', 2);
		execute('1', x"BFBB8000000000000000", x"BFBB8000000000000000",
			x"8", x"02", '0', 1);
		...
		execute('0', x"3FDE8000000000000000", x"3FDE8000000000000000", x"0", x"02", '1', 1);
